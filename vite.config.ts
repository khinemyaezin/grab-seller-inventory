    ...
    plugins: [
      ...
      federation({
        ...
        exposes: {
          ...
          "./ProductInventoryWidget": "./src/features/inventory/widgets/inventory-create-widget.tsx",
          "./InventoryItemEditWidget": "./src/features/inventory/widgets/inventory-edit-widget.tsx",
        },
        shared: {
