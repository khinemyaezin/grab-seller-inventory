...
import { projectInventoryEdit } from "@/features/inventory/lib/project-inventory";
import type { InventoryItemResponse } from "@/features/inventory/types";
import { useInventoryItemsForVariantId } from "@/features/inventory/api/use-inventory-items-for-variant-id";
import { useInventoryLink } from "@/features/inventory/api/use-root";
import { useLocations } from "@/features/inventory/api/use-locations";
